	...
	<div id="comments">
		<h4 class="woocommerce-Reviews-title">
			...
			if ( $count && wc_review_ratings_enabled() ) {
				...
				esc_html_e( 'Comment', 'woocommerce' );
			}
			?>
		</h4>
		...
		<?php if ( have_comments() ) : ?>
			...
			?>
		<?php else : ?>
			<p class="woocommerce-noreviews"><?php esc_html_e( 'There are no comment yet, Add the first comment.', 'woocommerce' ); ?></p>
		<?php endif; ?>
	</div>
		...
		<div id="review_form_wrapper">
			<div id="review_form">
				...
				$comment_form = array(
					...
					'title_reply'         => have_comments() ? esc_html__( 'Add a comment', 'woocommerce' ) : sprintf( esc_html__( 'Be the first to give honest rate &ldquo;%s&rdquo;', 'woocommerce' ), get_the_title() ),
					/* translators: %s is product title */
